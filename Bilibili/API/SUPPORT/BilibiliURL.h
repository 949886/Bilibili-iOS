...
#define BILIBILI_LINK_AV @"http://www.bilibili.com/video/av%@/"
#define BILIBILI_LINK_BANGUMI @"http://bangumi.bilibili.com/anime/v/%@"
...
#define BILIBILI_VIDEO_COMMENTS @"http://api.bilibili.com/x/reply"
#define BILIBILI_VIDEO_BP @"http://www.bilibili.com/widget/ajaxGetBP"       //B币
#define BILIBILI_VIDEO_PLAYURL @"http://interface.bilibili.com/playurl"     //视频接口
...
//#define BILIBILI_USER_INFO @"http://api.bilibili.cn/userinfo" //（API已死）
...
#define BILIBILI_LIVE_ROOM_INDEX @"http://live.bilibili.com/AppRoom/index"
#define BILIBILI_LIVE_ROOM_MESSAGE @"http://live.bilibili.com/AppRoom/msg"
...
#define BILIBILI_IPHONE_BANGUMI_INFO @"http://bangumi.bilibili.com/api/season_v4"
#define BILIBILI_IPHONE_BANGUMI_RELATIVE @"http://bangumi.bilibili.com/api/season/recommend/%@.json"
...
#define BILIBILI_LOGIN @"https://passport.bilibili.com/ajax/miniLogin/login"
#define BILIBILI_USER_INFO @"http://space.bilibili.com/ajax/member/GetInfo"
