...
@property (nonatomic, strong) BangumiUserSeason * user_season;
@property (nonatomic, strong) BangumiBpRank * rank;
...
@interface BangumiUserSeason : NSObject

@property (nonatomic, assign) NSInteger attention;
@property (nonatomic, assign) NSInteger last_ep_id;
@property (nonatomic, assign) NSInteger last_ep_index;
@property (nonatomic, assign) NSInteger last_time;

@end


@interface BangumiBpRank : NSObject

@property (nonatomic, assign) NSInteger week_bp_count;
@property (nonatomic, assign) NSInteger total_bp_count;

@property (nonatomic, copy) NSArray<SimpleUserModel *> * list;
