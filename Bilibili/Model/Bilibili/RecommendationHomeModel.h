...
@class RecommendationSegment, RecommendationElement;

@interface RecommendationHomeModel : NSObject

@property (nonatomic, copy) NSArray<RecommendationSegment *> * segments;    //数据部分，每一栏是一个segment
...
@interface RecommendationSegment : NSObject
...
@property (nonatomic, copy) NSArray<RecommendationElement *> * elements;    //数据部分，每个视频、直播等
...
@interface RecommendationElement : NSObject
...
@property (nonatomic, assign) NSInteger index;      //最新一集是第几集
